            ...
            <div class="row">
                <div class="col-md-6"><br>
                    ...
                    <textarea class="form-control gen-first required" data-name="Advice Name" data-lang-code="{{ $cur_lang->code }}"
                        ...
                        placeholder="Name in {{ $cur_lang->name }}"></textarea>
                </div>
                <div class="col-md-6">
                    @if (count($langs) > 0)
                        <div class="row">
                        ...
                        @foreach ($langs as $i)
                            <textarea class="form-control  adv_name {{ $loop->first ? 'active' : 'd-none' }}" id="adv_name_{{ $i->id }}"
                                name="adv_name_{{ $i->id }}" langName="{{ $i->name }}"></textarea>
                        @endforeach
                    @endif
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6"><br>
                    ...
                    <textarea class="form-control gen-first required" data-name="Breaf Information" data-lang-code="{{ $cur_lang->code }}"
                        ...
                        placeholder="Information in {{ $cur_lang->name }}"></textarea>
                </div>
                <div class="col-md-6">
                    @if (count($langs) > 0)
                        <div class="row">
                        ...
                        @foreach ($langs as $i)
                            <textarea class="form-control breaf_info {{ $loop->first ? 'active' : 'd-none' }}" id="breaf_info_{{ $i->id }}"
                                name="breaf_info_{{ $i->id }}" langName="{{ $i->name }}"></textarea>
                        @endforeach
                    @endif
                </div>
            </div>
                    ...
                    @if (count($langs) > 0)
                        ...
                        @foreach ($langs as $i)
                            <textarea class="form-control act_tip {{ $loop->first ? 'active' : 'd-none' }}" id="act_tip_{{ $i->id }}"
                                name="act_tip_{{ $i->id }}" langName="{{ $i->name }}"></textarea>
                        @endforeach
                    @endif
                </div>
            </div>
                    ...
                    @if (count($langs) > 0)
                        ...
                        @foreach ($langs as $i)
                            <textarea class="form-control tip_example {{ $loop->first ? 'active' : 'd-none' }}"
                                id="tip_example_{{ $i->id }}" name="tip_example_{{ $i->id }}" langName="{{ $i->name }}"></textarea>
                        @endforeach
                    @endif
                </div>
            </div>
